        ...
        try:
            ...
            with redirect_stdout(stdout_buffer), redirect_stderr(stderr_buffer):
                cli_main(
                    ...
                    plot_path="outputs/efficient_frontier.png",
                    frontier_points=31,
                    covariance_method=None,
                    ewma_decay=None,
                    ewma_mode=None,
                    tail_risk_method=None,
                    ...
                    factor_model=None,
                    pca_factors=None,
                    impact_temporary=None,
                    impact_permanent=None,
                    capacity_days=None,
                    liquidity_var_mode=None,
                    turnover_penalty=None,
                    no_trade_buffer=None,
                    dropna=True,
                    no_dropna=False,
                    show_risk_contrib=False,
                    debug=False,
                    log_level=log_level,
                )
        except Exception as exc:
